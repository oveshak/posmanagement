...
#         help_text="Example: user_list or /users/"
#     )
...
#         needed = [
#             f"{app}.{code}"
#             for app, code in self.permissions.values_list("content_type__app_label", "codename")
#         ]
#         if not needed:
#             return True
...
#     )
#     branchStaff = models.ManyToManyField(
#         "Users",
#         blank=True,
...
#         verbose_name="Area",
#     )
#     customer_Leader = models.CharField(max_length=100, null=True, blank=True, verbose_name="Customer Leader")
...
#     multi_branch = models.ManyToManyField(Branch, blank=True)
#     history = HistoricalRecords()
